...
export class Parent extends Component {
     ...
     */
    async init() {
        this.initFail = /** @type {import('/js/component.js').ErrorBoundary} */ (
        ...
        this.hydrateFail = /** @type {import('/js/component.js').ErrorBoundary} */ (
            this.createErrorBoundedChild(
        ...
        this.renderFail = /** @type {import('/js/component.js').ErrorBoundary} */ (
            this.createErrorBoundedChild(
        ...
        this.afterRenderFail = /** @type {import('/js/component.js').ErrorBoundary} */ (
            this.createErrorBoundedChild(
    ...
    retry(stage) {
        ...
        const boundary = /** @type {import('/js/component.js').ErrorBoundary} */ (
            this.createErrorBoundedChild(
        ...
        switch (stage) {
            case 'init':
                ...
                break;
            case 'hydrate':
                this.update({ hydrateFail: boundary, hydrateTries: this.hydrateTries });
                break;
            case 'render':
                this.update({ renderFail: boundary, renderTries: this.renderTries });
                break;
            case 'afterRender':
                this.update({ afterRenderFail: boundary, afterRenderTries: this.afterRenderTries });
                break;
        }
    }
}
